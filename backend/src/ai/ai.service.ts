...
export class AiService {
  ...
  async generateWhatsAppResponse(
    ...
    const systemPrompt = [
      ...
      '4b. NUNCA menciones, inventes ni copies datos bancarios, cuentas, CCI, titulares ni números de pago. Esos datos NO te los doy: los envía el sistema automáticamente con el tag [PAGO] cuando el cliente los pida.',
